...
dormont_table: Dict[str, LocData] = {
    ...
    "Dormont - Bonnie Flower":                  LocData(BaseId.Misc+5,     "Act 1", "has", "Bright Flower"),
    "Dormont - Isabeau Flower":                 LocData(BaseId.Misc+6,     "Act 1", "has", "Bright Flower"),
    "Dormont - Mirabelle Flower":               LocData(BaseId.Misc+7,     "Act 1", "has", "Bright Flower"),
    "Dormont - Odile Flower":                   LocData(BaseId.Misc+8,     "Act 1", "has", "Bright Flower"),
