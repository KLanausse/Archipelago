...
def create_all_regions(world: InStarsAndTimeWorld) -> None:
    ...
    overworld = Region("Act 1 - Dormont", world.player, world.multiworld)
...
def connect_regions(world: InStarsAndTimeWorld) -> None:
    ...
    overworld = world.get_region("Act 1 - Dormont")
    ...
    overworld_to_bottom_right_room = Entrance(world.player, "Act 1 - Dormont to Bottom Right Room", parent=overworld)
    ...
    overworld.connect(right_room, "Act 1 - Dormont to Right Room")
    right_room.connect(final_boss_room, "Right Room to Final Boss Room")

    # The region.connect helper even allows adding a rule immediately.
    # We'll talk more about rule creation in the set_all_rules() function in rules.py.
    overworld.connect(top_left_room, "Act 1 - Dormont to Top Left Room", lambda state: state.has("Key", world.player))
    ...
    if world.options.hammer:
        ...
        overworld.connect(top_middle_room, "Act 1 - Dormont to Top Middle Room")
