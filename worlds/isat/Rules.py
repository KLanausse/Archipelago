...
def set_all_entrance_rules(world: InStarsAndTimeWorld) -> None:
    # First, we need to actually grab our entrances. Luckily, there is a helper method for this.
    overworld_to_bottom_right_room = world.get_entrance("Act 1 - Dormont to Bottom Right Room")
    overworld_to_top_left_room = world.get_entrance("Act 1 - Dormont to Top Left Room")
    ...
    if world.options.hammer:
        overworld_to_top_middle_room = world.get_entrance("Act 1 - Dormont to Top Middle Room")
