...
from . import options as instarsandtime_options  # rename due to a name conflict with World.options
...
class InStarsAndTimeWorld(World):
    """
    In Stars And Time is a minimal 8bit-era inspired adventure game with grid-like movement.
    ...
    web = web_world.InStarsAndTimeWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "apquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = instarsandtime_options.InStarsAndTimeOptions
    options: instarsandtime_options.InStarsAndTimeOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    origin_region_name = "Dormont - Act 1"
